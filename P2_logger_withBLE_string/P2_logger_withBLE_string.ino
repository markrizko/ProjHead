...
BLEStringCharacteristic b_ID("f6a40646-f930-4075-b0f6-3da69ffce7-1d", BLERead, 3);
...
//      }
    ...
    EEPROM.put(EEPROM_IDX, (int)lsm.gyroData.x);
    EEPROM_IDX = EEPROM_IDX + sizeof(int);
    b_rot_x.writeValue(String((int)lsm.gyroData.x) + "dps");
    EEPROM.put(EEPROM_IDX, (int)lsm.gyroData.y);
    EEPROM_IDX = EEPROM_IDX + sizeof(int);
    b_rot_y.writeValue(String((int)lsm.gyroData.y) + "dps");
    EEPROM.put(EEPROM_IDX, (int)lsm.gyroData.z);
    EEPROM_IDX = EEPROM_IDX + sizeof(int);
    b_rot_z.writeValue(String((int)lsm.gyroData.x) + "dps");
